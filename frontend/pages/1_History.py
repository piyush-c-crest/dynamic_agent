...
from ui_components import inject_theme_css, render_workflow_view, status_badge
...
st.title("History")
st.caption("All runs from `data/runs/run_index.json`, with details from each `workflow.json`.")
