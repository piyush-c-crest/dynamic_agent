...
from models.schemas import AgentDefinition
...
class RegistryStore:
    ...
    def __init__(self, data_dir: Path = Config.REGISTRY_DIR):
        ...
        self.tool_registry_path = self.data_dir / "tool_registry.json"
    ...
    def load_tool_catalog(self) -> List[Dict[str, Any]]:
        """Loads all allowed tool definitions from tool_registry.json."""
